...
public class Compression {
    ...
    private final PKExploder pkexploderDecompress = new PKExploder();
    private final Huffman huffmanDecompress = new Huffman();
    private final ADPCM adpcmDecompress = new ADPCM(2);
