...
public class WarsmashClient implements ServerToClientListener, GameTurnManager {
    ...
    public void finishedTurn(final int gameTurnTick) {
        ...
        Gdx.app.postRunnable(() -> WarsmashClient.this.latestCompletedTurn = gameTurnTick);
    }
    ...
    public void startGame() {
        Gdx.app.postRunnable(() -> WarsmashClient.this.game.setGameTurnManager(WarsmashClient.this));
    }
