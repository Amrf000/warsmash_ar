...
public class EditBoxFrame extends AbstractRenderableFrame implements FocusableFrame {
    ...
    public EditBoxFrame(final String name, final UIFrame parent,
    ...
    public void setFilterAllowAny() {
        this.filter = character -> EditBoxFrame.this.editTextFrame.getFrameFont().getData().hasGlyph(character)
                && (character >= 32);
    }

    public interface CharacterFilter {
        CharacterFilter DEFAULT = character -> Character.isAlphabetic(character) || Character.isDigit(character) || (character == ' ');
