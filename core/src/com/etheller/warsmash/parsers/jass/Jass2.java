...
import com.etheller.warsmash.parsers.jass.triggers.*;
...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.trigger.enumtypes.*;
...
//				parser.removeErrorListener(ConsoleErrorListener.INSTANCE);
    ...
    private static void setupTriggerAPI(final JassProgramVisitor jassProgramVisitor, final HandleJassType triggerType,
        ...
        //
        jassProgramVisitor.getJassNativeManager().createNative("CreateTrigger", (arguments, globalScope, triggerScope) -> new HandleJassValue(triggerType, new Trigger()));
        ...
        jassProgramVisitor.getJassNativeManager().createNative("GetTriggeringTrigger", (arguments, globalScope, triggerScope) -> new HandleJassValue(triggerType, triggerScope.getTriggeringTrigger()));
        jassProgramVisitor.getJassNativeManager().createNative("GetTriggerEventId", (arguments, globalScope, triggerScope) -> new HandleJassValue(eventidType,
        ...
        jassProgramVisitor.getJassNativeManager().createNative("TriggerAddCondition", (arguments, globalScope, triggerScope) -> {
            ...
            return new HandleJassValue(triggerconditionType, new TriggerCondition(whichTrigger, index));
        });
        ...
        jassProgramVisitor.getJassNativeManager().createNative("TriggerAddAction", (arguments, globalScope, triggerScope) -> {
            ...
            return new HandleJassValue(triggeractionType, new TriggerAction(whichTrigger));
        });
    }
    ...
    private static JassFunction nullable(final List<JassValue> arguments,
                                         final JassFunctionJassValueVisitor visitor) {
        final JassValue arg = arguments.get(3);
        if (arg == null) {
            return null;
        }
        return arg.visit(visitor);
    ...
    private static void doPreloadScript(final DataSource dataSource, final War3MapViewer war3MapViewer,
        ...
        final JassProgramVisitor jassProgramVisitor = new JassProgramVisitor();
        jassProgramVisitor.getJassNativeManager().createNative("Preload", (arguments, globalScope, triggerScope) -> {
            final String filename1 = arguments.get(0).visit(StringJassValueVisitor.getInstance());
            war3MapViewer.load(filename1, war3MapViewer.mapPathSolver, war3MapViewer.solverParams);
            return null;
        });
        jassProgramVisitor.getJassNativeManager().createNative("PreloadEnd", (arguments, globalScope, triggerScope) -> {
...
//							parser.removeErrorListener(ConsoleErrorListener.INSTANCE);
    ...
    private static void registerConfigNatives(final JassProgramVisitor jassProgramVisitor,
        ...
        jassProgramVisitor.getJassNativeManager().createNative("SetGameTypeSupported", (arguments, globalScope, triggerScope) -> {
            final CGameType gameType = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
            final Boolean value = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
        ...
        jassProgramVisitor.getJassNativeManager().createNative("SetMapFlag", (arguments, globalScope, triggerScope) -> {
            final CMapFlag mapFlag = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
            final Boolean value = arguments.get(1).visit(BooleanJassValueVisitor.getInstance());
        ...
        jassProgramVisitor.getJassNativeManager().createNative("SetGameSpeed", (arguments, globalScope, triggerScope) -> {
            final CGameSpeed gameSpeed = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
        ...
        jassProgramVisitor.getJassNativeManager().createNative("GetTeams", (arguments, globalScope, triggerScope) -> new IntegerJassValue(mapConfig.getTeamCount()));
        jassProgramVisitor.getJassNativeManager().createNative("GetPlayers", (arguments, globalScope, triggerScope) -> new IntegerJassValue(mapConfig.getPlayerCount()));
        ...
        jassProgramVisitor.getJassNativeManager().createNative("GetGameTypeSelected", (arguments, globalScope, triggerScope) -> new HandleJassValue(gametypeType, mapConfig.getGameTypeSelected()));
        ...
        jassProgramVisitor.getJassNativeManager().createNative("GetGamePlacement", (arguments, globalScope, triggerScope) -> new HandleJassValue(placementType, mapConfig.getPlacement()));
        jassProgramVisitor.getJassNativeManager().createNative("GetGameSpeed", (arguments, globalScope, triggerScope) -> new HandleJassValue(gamespeedType, mapConfig.getGameSpeed()));
        jassProgramVisitor.getJassNativeManager().createNative("GetGameDifficulty", (arguments, globalScope, triggerScope) -> new HandleJassValue(gamedifficultyType, mapConfig.getGameDifficulty()));
        jassProgramVisitor.getJassNativeManager().createNative("GetResourceDensity", (arguments, globalScope, triggerScope) -> new HandleJassValue(mapdensityType, mapConfig.getResourceDensity()));
        jassProgramVisitor.getJassNativeManager().createNative("GetCreatureDensity", (arguments, globalScope, triggerScope) -> new HandleJassValue(mapdensityType, mapConfig.getCreatureDensity()));
        ...
        jassProgramVisitor.getJassNativeManager().createNative("GetPlayerNeutralAggressive", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 4));
        jassProgramVisitor.getJassNativeManager().createNative("GetBJPlayerNeutralVictim", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 3));
        jassProgramVisitor.getJassNativeManager().createNative("GetBJPlayerNeutralExtra", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 2));
        jassProgramVisitor.getJassNativeManager().createNative("GetPlayerNeutralPassive", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 1));
        jassProgramVisitor.getJassNativeManager().createNative("GetBJMaxPlayers", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS - 4));
        jassProgramVisitor.getJassNativeManager().createNative("GetBJMaxPlayerSlots", (arguments, globalScope, triggerScope) -> new IntegerJassValue(WarsmashConstants.MAX_PLAYERS));
    }
    ...
    public static void registerTypingNatives(final JassProgramVisitor jassProgramVisitor, final HandleJassType raceType,
        ...
        jassProgramVisitor.getJassNativeManager().createNative("ConvertMapVisibility", (arguments, globalScope, triggerScope) -> new HandleJassValue(mapvisibilityType, null));
        jassProgramVisitor.getJassNativeManager().createNative("ConvertMapSetting", (arguments, globalScope, triggerScope) -> new HandleJassValue(mapsettingType, null));
        ...
        jassProgramVisitor.getJassNativeManager().createNative("ConvertEffectType", (arguments, globalScope, triggerScope) -> {
            final int i = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
    ...
    private static final class JUIEnvironment {
        ...
        public JUIEnvironment(final JassProgramVisitor jassProgramVisitor, final DataSource dataSource,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("CreateSimpleFrame", (arguments, globalScope, triggerScope) -> {
                ...
                final UIFrame ownerFrame = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("FrameSetAnchor", (arguments, globalScope, triggerScope) -> {
                final UIFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("FrameSetPoint", (arguments, globalScope, triggerScope) -> {
                ...
                final FramePoint framePoint = arguments.get(1)
                        .visit(ObjectJassValueVisitor.getInstance());
                final UIFrame otherFrame = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("FrameSetText", (arguments, globalScope, triggerScope) -> {
                final StringFrame frame = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
    ...
    public static final class CommonEnvironment {
        ...
        private CommonEnvironment(final JassProgramVisitor jassProgramVisitor, final DataSource dataSource,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("UnitId", (arguments, globalScope, triggerScope) -> {
                final String idString = arguments.get(0).visit(StringJassValueVisitor.getInstance());
                final CUnitType unitType12 = CommonEnvironment.this.simulation.getUnitData()
                        .getUnitTypeByJassLegacyName(idString);
                if (unitType12 == null) {
                    return new IntegerJassValue(0);
                }
                return new IntegerJassValue(unitType12.getTypeId().getValue());
            });
            ...
            jassProgramVisitor.getJassNativeManager().createNative("AbilityId", (arguments, globalScope, triggerScope) -> new IntegerJassValue(0));
            jassProgramVisitor.getJassNativeManager().createNative("AbilityId2String", (arguments, globalScope, triggerScope) -> new StringJassValue(""));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetObjectName", (arguments, globalScope, triggerScope) -> {
                final Integer id = arguments.get(0).visit(IntegerJassValueVisitor.getInstance());
                final War3ID war3id = new War3ID(id);
                final CUnitType unitType1 = CommonEnvironment.this.simulation.getUnitData().getUnitType(war3id);
                if (unitType1 != null) {
                    return new StringJassValue(unitType1.getName());
                }
                ...
                final CDestructableType destructableType1 = CommonEnvironment.this.simulation.getDestructableData()
                        .getUnitType(war3id);
                if (destructableType1 != null) {
                    return new StringJassValue(destructableType1.getName());
                }
                return new StringJassValue("");
            });
            ...
            // Timer API
            //
            jassProgramVisitor.getJassNativeManager().createNative("CreateTimer", (arguments, globalScope, triggerScope) -> new HandleJassValue(timerType, new CTimerJass(globalScope,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("DestroyTimer", (arguments, globalScope, triggerScope) -> {
                final CTimerJass timer = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("TimerStart", (arguments, globalScope, triggerScope) -> {
                ...
                final JassFunction handlerFunc = nullable(arguments, JassFunctionJassValueVisitor.getInstance());
            ...
            // Group API
            //
            jassProgramVisitor.getJassNativeManager().createNative("CreateGroup", (arguments, globalScope, triggerScope) -> new HandleJassValue(groupType, new ArrayList<CUnit>()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GroupEnumUnitsInRect", (arguments, globalScope, triggerScope) -> {
                final List<CUnit> group = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
                final Rectangle rect = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
                final TriggerBooleanExpression filter = arguments.get(2)
                        .visit(ObjectJassValueVisitor.getInstance());
            ...
            // Force API
            //
            jassProgramVisitor.getJassNativeManager().createNative("CreateForce", (arguments, globalScope, triggerScope) -> new HandleJassValue(forceType, new ArrayList<CPlayerJass>()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetRectCenterX", new JassFunction() {
                final Vector2 centerHeap = new Vector2();
            ...
            jassProgramVisitor.getJassNativeManager().createNative("CreateRegion", (arguments, globalScope, triggerScope) -> new HandleJassValue(regionType, new CRegion()));
            jassProgramVisitor.getJassNativeManager().createNative("RemoveRegion", (arguments, globalScope, triggerScope) -> {
                final CRegion region = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("IsUnitInRegion", (arguments, globalScope, triggerScope) -> {
                final CRegion whichRegion = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
                final CUnit whichUnit = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetFilterUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getFilterUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetEnumUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getEnumUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetFilterDestructable", (arguments, globalScope, triggerScope) -> new HandleJassValue(destructableType,
                    ((CommonTriggerExecutionScope) triggerScope).getFilterDestructable()));
            jassProgramVisitor.getJassNativeManager().createNative("GetEnumDestructable", (arguments, globalScope, triggerScope) -> new HandleJassValue(destructableType,
                    ((CommonTriggerExecutionScope) triggerScope).getEnumDestructable()));
            jassProgramVisitor.getJassNativeManager().createNative("GetFilterItem", (arguments, globalScope, triggerScope) -> new HandleJassValue(itemType, ((CommonTriggerExecutionScope) triggerScope).getFilterItem()));
            jassProgramVisitor.getJassNativeManager().createNative("GetEnumItem", (arguments, globalScope, triggerScope) -> new HandleJassValue(itemType, ((CommonTriggerExecutionScope) triggerScope).getEnumItem()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterVariableEvent", (arguments, globalScope, triggerScope) -> {
                ...
                final CLimitOp limitOp = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTimerEvent", (arguments, globalScope, triggerScope) -> {
                ...
                return new HandleJassValue(eventType, (RemovableTriggerEvent) () -> CommonEnvironment.this.simulation.unregisterTimer(timer));
            });
            jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterTimerExpireEvent",
                    (arguments, globalScope, triggerScope) -> {
                        ...
                        return new HandleJassValue(eventType, (RemovableTriggerEvent) () -> timer.removeEvent(trigger));
                    });
            jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterGameStateEvent", (arguments, globalScope, triggerScope) -> {
                ...
                final CGameState whichState = arguments.get(1)
                        .visit(ObjectJassValueVisitor.getInstance());
                final CLimitOp opcode = arguments.get(2).visit(ObjectJassValueVisitor.getInstance());
                ...
                return new HandleJassValue(eventType, CommonEnvironment.this.simulation
                        .registerTimeOfDayEvent(globalScope, trigger, opcode, limitval));
            });
            if (JassSettings.CONTINUE_EXECUTING_ON_ERROR) {
                ...
                jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterUnitStateEvent",
                        (arguments, globalScope, triggerScope) -> new HandleJassValue(eventType, RemovableTriggerEvent.DO_NOTHING));
            }
            jassProgramVisitor.getJassNativeManager().createNative("DialogCreate", (arguments, globalScope, triggerScope) -> new HandleJassValue(dialogType, meleeUI.createScriptDialog(globalScope)));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetClickedButton", (arguments, globalScope, triggerScope) -> new HandleJassValue(buttonType,
                    ((CommonTriggerExecutionScope) triggerScope).getClickedButton()));
            jassProgramVisitor.getJassNativeManager().createNative("GetClickedDialog", (arguments, globalScope, triggerScope) -> new HandleJassValue(dialogType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("TriggerRegisterEnterRegion", (arguments, globalScope, triggerScope) -> {
                final Trigger trigger = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
                final CRegion region = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetTriggeringRegion", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType,
                    ((CommonTriggerExecutionScope) triggerScope).getEnteringUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetEnteringUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType,
                    ((CommonTriggerExecutionScope) triggerScope).getEnteringUnit()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetLeavingUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getLeavingUnit()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMinX", (arguments, globalScope, triggerScope) -> new RealJassValue(meleeUI.getCameraManager().getCameraBounds().getX()));
            jassProgramVisitor.getJassNativeManager().createNative("GetCameraBoundMinY", (arguments, globalScope, triggerScope) -> new RealJassValue(meleeUI.getCameraManager().getCameraBounds().getY()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetFloatGameState", (arguments, globalScope, triggerScope) -> {
                ...
                if (Objects.requireNonNull(gameState) == CGameState.TIME_OF_DAY) {
            ...
            jassProgramVisitor.getJassNativeManager().createNative("VersionGet", (arguments, globalScope, triggerScope) -> new HandleJassValue(versionType, CVersion.VALUES[WarsmashConstants.GAME_VERSION]));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("UnitAddAbility", (arguments, globalScope, triggerScope) -> {
                ...
                final CAbilityType<?> abilityType13 = CommonEnvironment.this.simulation.getAbilityData()
                        .getAbilityType(rawcode);
                if (abilityType13 == null) {
                    System.err.println(
                ...
                final CAbility ability = abilityType13
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetTriggerWidget", (arguments, globalScope, triggerScope) -> new HandleJassValue(widgetType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("DisplayTextToPlayer", (arguments, globalScope, triggerScope) -> {
                ...
                if (whichPlayer == CommonEnvironment.this.simulation
                        .getPlayer(war3MapViewer.getLocalPlayerIndex())) {
                    meleeUI.displayTimedText(x, y, ((float) message.length() / 6) + 5, message);
                }
                return null;
            });
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetFilterPlayer", (arguments, globalScope, triggerScope) -> new HandleJassValue(playerType,
                    ((CommonTriggerExecutionScope) triggerScope).getFilterPlayer()));
            jassProgramVisitor.getJassNativeManager().createNative("GetDyingUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getDyingUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetAttacker", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getAttacker()));
            jassProgramVisitor.getJassNativeManager().createNative("GetKillingUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType, ((CommonTriggerExecutionScope) triggerScope).getKillingUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetTriggerUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType,
                    ((CommonTriggerExecutionScope) triggerScope).getSpellAbilityUnit()));
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetUnit", (arguments, globalScope, triggerScope) -> new HandleJassValue(unitType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityId", (arguments, globalScope, triggerScope) -> new IntegerJassValue(
                    ((CommonTriggerExecutionScope) triggerScope).getSpellAbilityId().getValue()));
            jassProgramVisitor.getJassNativeManager().createNative("GetEnumPlayer", (arguments, globalScope, triggerScope) -> new HandleJassValue(playerType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetLocalPlayer", (arguments, globalScope, triggerScope) -> new HandleJassValue(playerType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("IsUnitInGroup", (arguments, globalScope, triggerScope) -> {
                final CUnit whichUnit = arguments.get(0).visit(ObjectJassValueVisitor.getInstance());
                final List<CUnit> group = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
                return BooleanJassValue.of(group.contains(whichUnit));
            });

            // Patch 1.23+ crap
            jassProgramVisitor.getJassNativeManager().createNative("InitHashtable", (arguments, globalScope, triggerScope) -> new HandleJassValue(hashtableType, new CHashtable()));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetExpiredTimer", (arguments, globalScope, triggerScope) -> new HandleJassValue(timerType,
            ...
            jassProgramVisitor.getJassNativeManager().createNative("IsNoVictoryCheat", (arguments, globalScope, triggerScope) -> BooleanJassValue.FALSE);
            jassProgramVisitor.getJassNativeManager().createNative("IsNoDefeatCheat", (arguments, globalScope, triggerScope) -> BooleanJassValue.FALSE);
            ...
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityOrderId", (arguments, globalScope, triggerScope) -> new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getSpellAbilityOrderId()));
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellAbilityOrderButton", (arguments, globalScope, triggerScope) -> new IntegerJassValue(((CommonTriggerExecutionScope) triggerScope).getSpellAbilityOrderId()));
            jassProgramVisitor.getJassNativeManager().createNative("GetSpellTargetType", (arguments, globalScope, triggerScope) -> new HandleJassValue(orderbuttontypeType,
                    ((CommonTriggerExecutionScope) triggerScope).getSpellAbilityTargetType()));
            jassProgramVisitor.getJassNativeManager().createNative("CreateAbilityType", (arguments, globalScope, triggerScope) -> new HandleJassValue(abilitytypeType, new CAbilityTypeJassDefinition(globalScope)));
            ...
            jassProgramVisitor.getJassNativeManager().createNative("AbilityTypeAddOrderButton", (arguments, globalScope, triggerScope) -> {
                final CAbilityTypeJassDefinition abilityType12 = arguments.get(0)
                        .visit(ObjectJassValueVisitor.getInstance());
                final JassOrder commandCard = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
                abilityType12.addJassOrder(commandCard);
                return null;
            });
            jassProgramVisitor.getJassNativeManager().createNative("AbilityTypeRemoveOrderButton", (arguments, globalScope, triggerScope) -> {
                final CAbilityTypeJassDefinition abilityType1 = arguments.get(0)
                        .visit(ObjectJassValueVisitor.getInstance());
                final JassOrder commandCard = arguments.get(1).visit(ObjectJassValueVisitor.getInstance());
                abilityType1.removeJassOrder(commandCard);
                return null;
            });
