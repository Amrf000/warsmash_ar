...
public class CommonTriggerExecutionScope extends TriggerExecutionScope {
    ...
    public static CommonTriggerExecutionScope jassAbilityTargetScope(final CUnit spellAbilityUnit, final CUnit targetUnit, final War3ID spellAbilityId,
    ...
    public static CommonTriggerExecutionScope jassAbilityTargetScope(final CUnit spellAbilityUnit, final War3ID spellAbilityId,
                                                                     final int spellAbilityOrderId, final JassOrderButtonType spellAbilityTargetType,
    ...
    public static CommonTriggerExecutionScope jassAbilityPointScope(final CUnit spellAbilityUnit, final AbilityPointTarget targetPoint, final War3ID spellAbilityId,
                                                                    final int spellAbilityOrderId, final JassOrderButtonType spellAbilityTargetType) {
        final CommonTriggerExecutionScope scope = new CommonTriggerExecutionScope(null, TriggerExecutionScope.EMPTY);
        scope.spellAbilityUnit = spellAbilityUnit;
        scope.triggeringUnit = spellAbilityUnit;
    ...
    public static CommonTriggerExecutionScope jassAbilityNoTargetScope(final CUnit spellAbilityUnit, final War3ID spellAbilityId, final int spellAbilityOrderId,
    ...
    public static CommonTriggerExecutionScope jassAbilityBasicScope(final CUnit spellAbilityUnit, final War3ID spellAbilityId) {
        final CommonTriggerExecutionScope scope = new CommonTriggerExecutionScope(null, TriggerExecutionScope.EMPTY);
        scope.spellAbilityUnit = spellAbilityUnit;
        scope.triggeringUnit = spellAbilityUnit;
        scope.spellAbilityId = spellAbilityId;
    ...
    public static CommonTriggerExecutionScope jassAbilityBasicScope(final CUnit spellAbilityUnit, final War3ID spellAbilityId, final int spellAbilityOrderId) {
        final CommonTriggerExecutionScope scope = new CommonTriggerExecutionScope(null, TriggerExecutionScope.EMPTY);
        scope.spellAbilityUnit = spellAbilityUnit;
        scope.triggeringUnit = spellAbilityUnit;
        scope.spellAbilityId = spellAbilityId;
