...
public class Geoset {
    ...
    public final int skinOffset;
    public final int faceOffset;
    public final int vertices;
    public final int elements;
    public GeosetAnimation geosetAnimation;
    public final Variants variants;
    public final boolean hasAlphaAnim;
    public final boolean hasColorAnim;
    public final boolean hasObjectAnim;
    ...
    public void getAlpha(final float[] out, final int sequence, final int frame, final int counter) {
        if (this.geosetAnimation != null) {
            this.geosetAnimation.getAlpha(out, sequence, frame, counter);
            return;
        }
