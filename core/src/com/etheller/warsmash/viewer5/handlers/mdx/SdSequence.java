...
public final class SdSequence<TYPE> {
    private static final boolean INJECT_FRAMES_GHOSTWOLF_STYLE = false;
    ...
    public final TYPE[] inTans;
    public final TYPE[] outTans;
    ...
    private boolean equals(final TYPE a, final TYPE b) {
