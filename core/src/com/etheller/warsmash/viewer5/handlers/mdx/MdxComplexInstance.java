...
public class MdxComplexInstance extends ModelInstance {
    ...
    public final List<AttachmentInstance> attachments = new ArrayList<>();
    public final List<ParticleEmitter> particleEmitters = new ArrayList<>();
    public final List<ParticleEmitter2> particleEmitters2 = new ArrayList<>();
    public final List<RibbonEmitter> ribbonEmitters = new ArrayList<>();
    public final List<EventObjectEmitter<?, ?>> eventObjectEmitters = new ArrayList<>();
    ...
    public final float[] vertexColor = {1, 1, 1, 1};
    ...
    public final Texture[] replaceableTextures = new Texture[WarsmashConstants.REPLACEABLE_TEXTURE_LIMIT];
    public final Texture[] replaceableTextures_diffuse = new Texture[WarsmashConstants.REPLACEABLE_TEXTURE_LIMIT];
    public final Texture[] replaceableTextures_normal = new Texture[WarsmashConstants.REPLACEABLE_TEXTURE_LIMIT];
    public final Texture[] replaceableTextures_orm = new Texture[WarsmashConstants.REPLACEABLE_TEXTURE_LIMIT];
    ...
    public void load() {
        ...
        int nodeIndex = 0;
        this.nodes = nodes.toArray(new MdxNode[0]);
    ...
    public void updateBoneTexture() {
        if (this.boneTexture != null) {
            ...
            for (int i = 0, l = this.worldMatrices.length; i < l; i++) {
                ...
                this.worldMatricesCopyHeap.put((i * 16), worldMatrix.val[Matrix4.M00]);
     ...
     */
    public void setTeamColor(final int id) {
     ...
     */
    public void setVertexColor(final float[] color) {
    ...
    public void setVertexAlpha(final float alpha) {
     ...
     */
    public void setSequence(final int id) {
        final MdxModel model = (MdxModel) this.model;
            ...
            if ((id < 0) || (id > (sequences.size() - 1))) {
                ...
                if ((this.blendTime > 0) && (lastSequence != -1)) {
                    if ((this.blendTimeRemaining <= 0) && (this.counter > 0)) {
                        ...
                        for (final SkeletalNode node : this.sortedNodes) {
                            node.beginBlending();
                        }
                    }
                }
     ...
     * spawned effects
     */
    public void setSequenceLoopMode(final SequenceLoopMode mode) {
