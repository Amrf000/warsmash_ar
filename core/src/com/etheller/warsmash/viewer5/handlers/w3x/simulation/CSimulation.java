...
public class CSimulation implements CPlayerAPI {
    ...
    private final transient CommandErrorListener commandErrorListener;
    ...
    public CSimulation(final War3MapConfig config, final DataTable miscData, final MutableObjectData parsedUnitData,
        ...
        for (int i = 0; i < WarsmashConstants.MAX_PLAYERS; i++) {
            final CBasePlayer configPlayer =
                    config.getPlayer(i);
    ...
    public void createProjectile(final CUnit source, final float launchX, final float launchY,
    ...
    public void update() {
        ...
        this.projectiles.removeIf(projectile -> projectile.update(this));
    ...
    public CWidget getWidget(final int handleId) {
        ...
        return this.handleIdToItem.get(handleId);
    }
    ...
    public RemovableTriggerEvent registerTimeOfDayEvent(final GlobalScope globalScope, final Trigger trigger,
        ...
        return () -> CSimulation.this.timeOfDayVariableEvents.remove(timeOfDayVariableEvent);
    }
