...
//						System.out.println(attackType + ":" + defenseType + ": " + damageComponents[j]);
        ...
        int heroMaxReviveCostGold = miscData.getFieldValue("HeroMaxReviveCostGold");
        int heroMaxReviveCostLumber = miscData.getFieldValue("HeroMaxReviveCostLumber");
        int heroMaxReviveTime = miscData.getFieldValue("HeroMaxReviveTime");

        int heroMaxAwakenCostGold = miscData.getFieldValue("HeroMaxAwakenCostGold");
        int heroMaxAwakenCostLumber = miscData.getFieldValue("HeroMaxAwakenCostLumber");
        ...
        float heroAwakenManaStart = miscData.getFieldFloatValue("HeroAwakenManaStart");
        float heroAwakenManaFactor = miscData.getFieldFloatValue("HeroAwakenManaFactor");
        float heroAwakenLifeFactor = miscData.getFieldFloatValue("HeroAwakenLifeFactor");
        ...
        float awakenBaseFactor = miscData.getFieldFloatValue("AwakenBaseFactor");
        float awakenLevelFactor = miscData.getFieldFloatValue("AwakenLevelFactor");
        float awakenBaseLumberFactor = miscData.getFieldFloatValue("AwakenBaseLumberFactor");
        float awakenLumberLevelFactor = miscData.getFieldFloatValue("AwakenLumberLevelFactor");
        float awakenMaxFactor = miscData.getFieldFloatValue("AwakenMaxFactor");

        this.maxHeroLevel = miscData.getFieldValue("MaxHeroLevel");
        this.maxUnitLevel = miscData.getFieldValue("MaxUnitLevel");

        int needHeroXPFormulaA = miscData.getFieldValue("NeedHeroXPFormulaA");
        int needHeroXPFormulaB = miscData.getFieldValue("NeedHeroXPFormulaB");
        int needHeroXPFormulaC = miscData.getFieldValue("NeedHeroXPFormulaC");
        int grantHeroXPFormulaA = miscData.getFieldValue("GrantHeroXPFormulaA");
        int grantHeroXPFormulaB = miscData.getFieldValue("GrantHeroXPFormulaB");
        int grantHeroXPFormulaC = miscData.getFieldValue("GrantHeroXPFormulaC");
        int grantNormalXPFormulaA = miscData.getFieldValue("GrantNormalXPFormulaA");
        int grantNormalXPFormulaB = miscData.getFieldValue("GrantNormalXPFormulaB");
        int grantNormalXPFormulaC = miscData.getFieldValue("GrantNormalXPFormulaC");

        this.needHeroXp = parseTable(miscData.getField("NeedHeroXP"), needHeroXPFormulaA, needHeroXPFormulaB,
                needHeroXPFormulaC, this.maxHeroLevel);
        ...
        this.grantHeroXp = parseTable(miscData.getField("GrantHeroXP"), grantHeroXPFormulaA,
                grantHeroXPFormulaB, grantHeroXPFormulaC, this.maxHeroLevel);
        this.grantNormalXp = parseTable(miscData.getField("GrantNormalXP"), grantNormalXPFormulaA,
                grantNormalXPFormulaB, grantNormalXPFormulaC, this.maxUnitLevel);
