...
public class PathingGrid {
    ...
    public enum MovementType {
        ...
        MovementType(final String typeKey) {
    ...
    public enum PathingType {
        ...
        PathingType(final int preventionFlag) {
            this.preventionFlag = preventionFlag;
        }
    }

    public static final class PathingFlags {
        public static final int UNWALKABLE = 0x2;
        public static final int UNFLYABLE = 0x4;
        public static final int UNBUILDABLE = 0x8;
        public static final int BLIGHTED = 0x20;
        public static final int UNSWIMABLE = 0x40; // PROBABLY, didn't confirm this flag value is accurate
