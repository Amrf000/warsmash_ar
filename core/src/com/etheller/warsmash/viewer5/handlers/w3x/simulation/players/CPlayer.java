...
public class CPlayer extends CBasePlayer {
    ...
    private final transient CPlayerStateNotifier stateNotifier = new CPlayerStateNotifier();
    private int gold;
    private int lumber;
    ...
    public void addTechtreeUnlocked(final War3ID rawcode) {
        this.rawcodeToTechtreeUnlocked.merge(rawcode, 1, Integer::sum);
    }
    ...
    public void addTechtreeInProgress(final War3ID rawcode) {
        this.rawcodeToTechtreeInProgress.merge(rawcode, 1, Integer::sum);
    }
    ...
    private List<CPlayerEvent> getOrCreateEventList(final JassGameEventsWar3 eventType) {
        List<CPlayerEvent> playerEvents = this.eventTypeToEvents.computeIfAbsent(eventType, k -> new ArrayList<>());
        return playerEvents;
    }
