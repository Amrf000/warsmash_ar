...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.*;
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilities.build.*;
...
import com.etheller.warsmash.viewer5.handlers.w3x.ui.command.*;
...
public class MeleeUI implements CUnitStateListener, CommandButtonListener, CommandCardCommandListener,
    ...
    public final int[][] commandCardGridHotkeys = {{Input.Keys.Q, Input.Keys.W, Input.Keys.E, Input.Keys.R},
...
//	private final List<StringFrame> gameMessageFrames = new ArrayList<>();
    ...
    public MeleeUI(final DataSource dataSource, final ExtendViewport uiViewport, final Scene uiScene,
        ...
        Texture activeButtonTexture = ImageUtils.getAnyExtensionTexture(war3MapViewer.mapMpq,
    ...
    public void main() {
        ...
        UIFrame consoleUI = this.rootFrame.createSimpleFrame("ConsoleUI", this.rootFrame);
        Objects.requireNonNull(consoleUI).setSetAllPoints(true);
        ...
        UIFrame resourceBar = this.rootFrame.createSimpleFrame("ResourceBarFrame", consoleUI);
        Objects.requireNonNull(resourceBar).addSetPoint(new SetPoint(FramePoint.TOPRIGHT, consoleUI, FramePoint.TOPRIGHT, 0, 0));
        this.resourceBarGoldText = (StringFrame) this.rootFrame.getFrameByName("ResourceBarGoldText");
        goldChanged();
        this.resourceBarLumberText = (StringFrame) this.rootFrame.getFrameByName("ResourceBarLumberText");
        lumberChanged();
        this.resourceBarSupplyText = (StringFrame) this.rootFrame.getFrameByName("ResourceBarSupplyText");
        foodChanged();
        this.resourceBarUpkeepText = (StringFrame) this.rootFrame.getFrameByName("ResourceBarUpkeepText");
        upkeepChanged();

        final UIFrame upperButtonBar = this.rootFrame.createSimpleFrame("UpperButtonBarFrame", consoleUI);
        Objects.requireNonNull(upperButtonBar).addSetPoint(new SetPoint(FramePoint.TOPLEFT, consoleUI, FramePoint.TOPLEFT, 0, 0));

        SimpleButtonFrame questsButton = (SimpleButtonFrame) this.rootFrame.getFrameByName("UpperButtonBarQuestsButton");
        questsButton.setEnabled(false);
        SimpleButtonFrame menuButton = (SimpleButtonFrame) this.rootFrame.getFrameByName("UpperButtonBarMenuButton");
        SimpleButtonFrame alliesButton = (SimpleButtonFrame) this.rootFrame.getFrameByName("UpperButtonBarAlliesButton");
        alliesButton.setEnabled(false);
        SimpleButtonFrame chatButton = (SimpleButtonFrame) this.rootFrame.getFrameByName("UpperButtonBarChatButton");
        chatButton.setEnabled(false);

        this.smashEscMenu = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashEscMenu", this.rootFrame);
        Objects.requireNonNull(this.smashEscMenu).addAnchor(new AnchorDefinition(FramePoint.TOP, 0, GameUI.convertY(this.uiViewport, -0.05f)));
        final UIFrame escMenuBackdrop = this.rootFrame.createFrame("EscMenuBackdrop", this.smashEscMenu);
        escMenuBackdrop.setVisible(false);
        final UIFrame escMenuMainPanel = this.rootFrame.createFrame("EscMenuMainPanel", this.smashEscMenu);
        escMenuMainPanel.setVisible(false);
        this.smashEscMenu.add(escMenuBackdrop);
        this.smashEscMenu.add(escMenuMainPanel);

        final UIFrame escMenuInnerMainPanel = this.rootFrame.getFrameByName("MainPanel");
        final GlueTextButtonFrame pauseButton = (GlueTextButtonFrame) this.rootFrame.getFrameByName("PauseButton");
        ...
        final GlueTextButtonFrame helpButton = (GlueTextButtonFrame) this.rootFrame.getFrameByName("HelpButton");
        helpButton.setEnabled(false);
        final GlueTextButtonFrame tipsButton = (GlueTextButtonFrame) this.rootFrame.getFrameByName("TipsButton");
        ...
        final GlueTextButtonFrame returnButton = (GlueTextButtonFrame) this.rootFrame.getFrameByName("ReturnButton");

        final UIFrame escMenuInnerEndGamePanel = this.rootFrame.getFrameByName("EndGamePanel");
        final GlueTextButtonFrame endGamePreviousButton = (GlueTextButtonFrame) this.rootFrame
                .getFrameByName("PreviousButton");
        ...
        final UIFrame escMenuInnerConfirmQuitPanel = this.rootFrame.getFrameByName("ConfirmQuitPanel");
        final GlueTextButtonFrame confirmQuitCancelButton = (GlueTextButtonFrame) this.rootFrame
                .getFrameByName("ConfirmQuitCancelButton");
        final GlueTextButtonFrame confirmQuitQuitButton = (GlueTextButtonFrame) this.rootFrame
                .getFrameByName("ConfirmQuitQuitButton");
        final UIFrame escMenuInnerHelpPanel = this.rootFrame.getFrameByName("HelpPanel");
        final UIFrame escMenuInnerTipsPanel = this.rootFrame.getFrameByName("TipsPanel");
        ...
        this.timeIndicator = (SpriteFrame) this.rootFrame.createFrame("TimeOfDayIndicator", this.rootFrame);
        ...
        positionPortrait();
        UIFrame unitPortrait = this.rootFrame.createSimpleFrame("UnitPortrait", consoleUI);
        this.unitLifeText = (StringFrame) this.rootFrame.getFrameByName("UnitPortraitHitPointText");
        this.unitManaText = (StringFrame) this.rootFrame.getFrameByName("UnitPortraitManaPointText");
        ...
        UIFrame smashSimpleInfoPanel = this.rootFrame.createSimpleFrame("SmashSimpleInfoPanel", this.rootFrame);
        Objects.requireNonNull(smashSimpleInfoPanel)
        ...
        this.simpleNameValue = (StringFrame) this.rootFrame.getFrameByName("SimpleNameValue");
        this.simpleClassValue = (StringFrame) this.rootFrame.getFrameByName("SimpleClassValue");
        this.simpleBuildingActionLabel = (StringFrame) this.rootFrame.getFrameByName("SimpleBuildingActionLabel");
        ...
        this.simpleHeroLevelBar = (SimpleStatusBarFrame) this.rootFrame.getFrameByName("SimpleHeroLevelBar");
        ...
        this.simpleInfoPanelBuildingDetail = this.rootFrame.createSimpleFrame("SimpleInfoPanelBuildingDetail",
                smashSimpleInfoPanel);
        this.simpleBuildingNameValue = (StringFrame) this.rootFrame.getFrameByName("SimpleBuildingNameValue");
        this.simpleBuildingDescriptionValue = (StringFrame) this.rootFrame
                .getFrameByName("SimpleBuildingDescriptionValue");
        this.simpleBuildingBuildingActionLabel = (StringFrame) this.rootFrame
                .getFrameByName("SimpleBuildingActionLabel");
        this.simpleBuildingBuildTimeIndicator = (SimpleStatusBarFrame) this.rootFrame
                .getFrameByName("SimpleBuildTimeIndicator");
        ...
        final TextureFrame simpleBuildQueueBackdrop = (TextureFrame) this.rootFrame
                .getFrameByName("SimpleBuildQueueBackdrop");
        ...
        this.queueIconFrames[0] = new QueueIcon("SmashBuildQueueIcon0", smashSimpleInfoPanel, this, 0);
        ...
        for (int i = 1; i < this.queueIconFrames.length; i++) {
            this.queueIconFrames[i] = new QueueIcon("SmashBuildQueueIcon" + i, smashSimpleInfoPanel, this, i);
            ...
            this.queueIconFrames[i].addSetPoint(new SetPoint(FramePoint.CENTER, smashSimpleInfoPanel,
        ...
        this.selectWorkerInsideFrame = new QueueIcon("SmashBuildQueueWorkerIcon", smashSimpleInfoPanel, this, 1);
                ...
                selectedSubgroupHighlightBackdrop
                        .addSetPoint(new SetPoint(FramePoint.TOPLEFT, smashSimpleInfoPanel, FramePoint.TOPLEFT,
                                ...
                                (((this.frontQueueIconWidth * .37f) / 2) + (this.frontQueueIconWidth * -.75f))
                                        - (this.frontQueueIconWidth * 1.5f * ((float) i / halfSelectionMaxSize))));
            }
            {
        ...
        MultiSelectionIconListener cargoClickListener = new MultiSelectionIconListener() {
            @Override
        ...
        MultiSelectionIconListener multiSelectClickListener = new MultiSelectionIconListener() {
            @Override
            public void multiSelectIconClicked(final int index) {
                if (index < MeleeUI.this.selectedUnits.size()) {
                    ...
                    if (MeleeUI.this.activeCommand != null) {
                        ...
                        final List<RenderWidget> newSelection = Collections.singletonList(MeleeUI.this.selectedUnit);
        ...
        for (int i = 0; i < this.selectedUnitFrames.length; i++) {
            this.selectedUnitFrames[i] = new MultiSelectionIcon("SmashMultiSelectUnitIcon", smashSimpleInfoPanel,
        ...
        for (int i = 0; i < this.cargoUnitFrames.length; i++) {
            this.cargoUnitFrames[i] = new MultiSelectionIcon("SmashMultiSelectUnitIcon", smashSimpleInfoPanel,
        ...
        SimpleFrame smashAttack1IconWrapper = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashSimpleInfoPanelIconDamage",
                this.simpleInfoPanelUnitDetail);
        Objects.requireNonNull(smashAttack1IconWrapper).addSetPoint(new SetPoint(FramePoint.TOPLEFT, this.simpleInfoPanelUnitDetail,
                FramePoint.TOPLEFT, 0, GameUI.convertY(this.uiViewport, -0.040f)));
        smashAttack1IconWrapper.setWidth(GameUI.convertX(this.uiViewport, 0.1f));
        smashAttack1IconWrapper.setHeight(GameUI.convertY(this.uiViewport, 0.030125f));
        this.attack1Icon = this.rootFrame.createSimpleFrame("SimpleInfoPanelIconDamage", smashAttack1IconWrapper
        );
        this.attack1IconBackdrop = (TextureFrame) this.rootFrame.getFrameByName("InfoPanelIconBackdrop");
        this.attack1InfoPanelIconValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconValue");
        this.attack1InfoPanelIconLevel = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconLevel");

        SimpleFrame smashAttack2IconWrapper = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashSimpleInfoPanelIconDamage",
                this.simpleInfoPanelUnitDetail);
        Objects.requireNonNull(smashAttack2IconWrapper)
        ...
        smashAttack2IconWrapper.setWidth(GameUI.convertX(this.uiViewport, 0.1f));
        smashAttack2IconWrapper.setHeight(GameUI.convertY(this.uiViewport, 0.030125f));
        this.attack2Icon = this.rootFrame.createSimpleFrame("SimpleInfoPanelIconDamage", smashAttack2IconWrapper
        );
        this.attack2IconBackdrop = (TextureFrame) this.rootFrame.getFrameByName("InfoPanelIconBackdrop");
        this.attack2InfoPanelIconValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconValue");
        this.attack2InfoPanelIconLevel = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconLevel");

        this.smashArmorIconWrapper = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashSimpleInfoPanelIconArmor",
                this.simpleInfoPanelUnitDetail);
        Objects.requireNonNull(this.smashArmorIconWrapper).addSetPoint(new SetPoint(FramePoint.TOPLEFT, this.simpleInfoPanelUnitDetail,
        ...
        this.armorIcon = this.rootFrame.createSimpleFrame("SimpleInfoPanelIconArmor", this.smashArmorIconWrapper);
        this.armorIconBackdrop = (TextureFrame) this.rootFrame.getFrameByName("InfoPanelIconBackdrop");
        this.armorInfoPanelIconValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconValue");
        this.armorInfoPanelIconLevel = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconLevel");

        SimpleFrame smashHeroInfoPanelWrapper = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashSimpleInfoPanelIconHero",
                this.simpleInfoPanelUnitDetail);
        Objects.requireNonNull(smashHeroInfoPanelWrapper).addSetPoint(new SetPoint(FramePoint.TOPLEFT, this.simpleInfoPanelUnitDetail,
                FramePoint.TOPLEFT, GameUI.convertX(this.uiViewport, 0.1f), GameUI.convertY(this.uiViewport, -0.037f)));
        smashHeroInfoPanelWrapper.setWidth(GameUI.convertX(this.uiViewport, 0.1f));
        smashHeroInfoPanelWrapper.setHeight(GameUI.convertY(this.uiViewport, 0.0625f));
        this.heroInfoPanel = this.rootFrame.createSimpleFrame("SimpleInfoPanelIconHero", smashHeroInfoPanelWrapper
        );
        this.primaryAttributeIcon = (TextureFrame) this.rootFrame.getFrameByName("InfoPanelIconHeroIcon");
        this.strengthValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconHeroStrengthValue");
        this.agilityValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconHeroAgilityValue");
        this.intelligenceValue = (StringFrame) this.rootFrame.getFrameByName("InfoPanelIconHeroIntellectValue");

        this.inventoryBarFrame = (SimpleFrame) this.rootFrame.createSimpleFrame("SmashSimpleInventoryBar",
                this.rootFrame);
        Objects.requireNonNull(this.inventoryBarFrame).setWidth(GameUI.convertX(this.uiViewport, 0.079f));
        this.inventoryBarFrame.setHeight(GameUI.convertY(this.uiViewport, 0.115f));
        this.inventoryBarFrame.addSetPoint(new SetPoint(FramePoint.BOTTOMRIGHT, consoleUI, FramePoint.BOTTOMLEFT,
        ...
        for (int j = 0; j < INVENTORY_HEIGHT; j++) {
            for (int i = 0; i < INVENTORY_WIDTH; i++) {
                ...
                final SpriteFrame cooldownFrame = (SpriteFrame) this.rootFrame.createFrameByType("SPRITE",
                        "SmashInventoryButton_" + (commandButtonIndex) + "_Cooldown", this.rootFrame, "");
        ...
        StringFrame inventoryTitleFrame = this.rootFrame.createStringFrame("SmashInventoryText", this.inventoryBarFrame,
                new Color(0xFCDE12FF), TextJustify.CENTER, TextJustify.MIDDLE, 0.0109f);
        this.rootFrame.setText(inventoryTitleFrame, this.rootFrame.getTemplates().getDecoratedString("INVENTORY"));
        inventoryTitleFrame
        ...
        inventoryTitleFrame.setWidth(GameUI.convertX(this.uiViewport, 0.071f));
        inventoryTitleFrame.setHeight(GameUI.convertX(this.uiViewport, 0.01125f));
        inventoryTitleFrame.setFontShadowColor(new Color(0f, 0f, 0f, 0.9f));
        inventoryTitleFrame.setFontShadowOffsetX(GameUI.convertX(this.uiViewport, 0.001f));
        inventoryTitleFrame.setFontShadowOffsetY(GameUI.convertY(this.uiViewport, -0.001f));
        ...
        this.inventoryCover = this.rootFrame.createSimpleFrame("SmashConsoleInventoryCover", this.rootFrame);
        ...
        for (int j = 0; j < COMMAND_CARD_HEIGHT; j++) {
            for (int i = 0; i < COMMAND_CARD_WIDTH; i++) {
                ...
                final TextureFrame numberOverlayFrame = new TextureFrame(
                        "SmashCommandButton_" + (commandButtonIndex) + "_NumberOverlay", this.rootFrame, true, null);
                final SpriteFrame cooldownFrame = (SpriteFrame) this.rootFrame.createFrameByType("SPRITE",
                        "SmashCommandButton_" + (commandButtonIndex) + "_Cooldown", this.rootFrame, "");
                final SpriteFrame autocastFrame = (SpriteFrame) this.rootFrame.createFrameByType("SPRITE",
                        "SmashCommandButton_" + (commandButtonIndex) + "_Autocast", this.rootFrame, "");
...
//				numberOverlayStringFrame.addAnchor(new AnchorDefinition(FramePoint.CENTER, 0, 0));
        ...
        this.tooltipFrame = this.rootFrame.createFrame("SmashToolTip", this.rootFrame);
        ...
        this.tooltipText = (StringFrame) this.rootFrame.getFrameByName("SmashToolTipText");
        ...
        this.hovertipFrame = this.rootFrame.createFrame("SmashHoverTip", this.rootFrame);
        this.hovertipText = (StringFrame) this.rootFrame.getFrameByName("SmashHoverTipText");
        ...
        this.tooltipUberTipText = (StringFrame) this.rootFrame.getFrameByName("SmashUberTipText");
        ...
        for (int i = 0; i < this.tooltipResourceFrames.length; i++) {
            this.tooltipResourceFrames[i] = this.rootFrame.createFrame("SmashToolTipIconResource", this.tooltipFrame
            );
            this.tooltipResourceIconFrames[i] = (TextureFrame) this.rootFrame
                    .getFrameByName("SmashToolTipIconResourceBackdrop");
            this.tooltipResourceTextFrames[i] = (StringFrame) this.rootFrame
                    .getFrameByName("SmashToolTipIconResourceLabel");
...
//		this.tooltipFrame = this.rootFrame.createFrameByType("BACKDROP", "SmashToolTipBackdrop", this.rootFrame, "", 0);
    ...
    public void update(final float deltaTime) {
        ...
        if (this.currentlyDraggingPointer == -1) {
            if ((this.mouseOverUnit != null) && isUnitSelectable(this.mouseOverUnit)) {
                ...
                positionHealthBar(simpleStatusBarFrame, this.mouseOverUnit);
            ...
            this.war3MapViewer.simulation.getWorldCollision().enumUnitsInRect(this.tempRect, unit -> {
                ...
                if (!unit.isDead() && renderUnit.isSelectable()
                    ...
                    if (!unit.isInvulnerable()) {
                        positionHealthBar(simpleStatusBarFrame, renderUnit);
                    }
    ...
    private String getWorldFrameHoverTipText(final RenderWidget whichUnit) {
        if (whichUnit instanceof RenderUnit) {
            ...
            return renderDest.getSimulationDestructable().getDestType().getName();
        }
        return null;
    }
    ...
    private void positionHealthBar(final SimpleStatusBarFrame simpleStatusBarFrame, final RenderWidget unit) {
        ...
        simpleStatusBarFrame.getBorderFrame().setColor(0f, 0f, 0f, (float) 1.0);
        ...
        simpleStatusBarFrame.getBarFrame().setColor(Math.min(1.0f, 2.0f - (lifeRatioRemaining * 2)),
                Math.min(1.0f, lifeRatioRemaining * 2), 0, (float) 1.0);
    ...
    private void reloadSelectedUnitUI(final RenderUnit unit) {
        ...
        if ((simulationUnit.getBuildQueue()[0] != null)
            ...
            for (QueueIcon queueIconFrame : this.queueIconFrames) {
                queueIconFrame.setVisible(false);
            }
            for (int i = 0; i < this.selectedUnitFrames.length; i++) {
    ...
    public void commandButton(final int buttonPositionX, final int buttonPositionY, final Texture icon,
        ...
        while (y < COMMAND_CARD_HEIGHT && this.commandCard[y][x].isVisible()) {
            x++;
    ...
    public void keyDown(final int keycode) {
        ...
        this.cameraManager.keyDown(keycode);
    }

    public void keyUp(final int keycode) {
        this.cameraManager.keyUp(keycode);
    }
    ...
    public CTimerDialog createTimerDialog(final CTimer timer) {
        final UIFrame timerDialog = this.rootFrame.createFrame("TimerDialog", this.rootFrame);
        final StringFrame valueFrame = (StringFrame) this.rootFrame.getFrameByName("TimeDialogValue");
        final StringFrame titleFrame = (StringFrame) this.rootFrame.getFrameByName("TimerDialogTitle");
    ...
    public CScriptDialog createScriptDialog(final GlobalScope globalScope) {
        final SimpleFrame scriptDialog = (SimpleFrame) this.rootFrame.createFrame("ScriptDialog", this.rootFrame);
        ...
        final StringFrame scriptDialogTextFrame = (StringFrame) this.rootFrame.getFrameByName("ScriptDialogText");
    ...
    public void createScriptDialogButton(final CScriptDialog scriptDialog, final String text,
                                         final char hotkey) {
        // TODO use hotkey
        final GlueTextButtonFrame scriptDialogButton = (GlueTextButtonFrame) this.rootFrame
                .createFrame("ScriptDialogButton", scriptDialog.getScriptDialogFrame());
                ...
                for (final CUnitAttack attack : MeleeUI.this.activeCommandUnit.getSimulationUnit().getAttacks()) {
                    if (attack.getWeaponType().isAttackGroundSupported()) {
                        if (attack instanceof CUnitAttackMissileSplash) {
                            radius = ((CUnitAttackMissileSplash) attack)
