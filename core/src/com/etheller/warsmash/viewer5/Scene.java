...
public abstract class Scene {
    ...
    public void removeInstance(final ModelInstance instance) {
        if (instance.scene == this) {
    ...
    public void update(final float dt) {
        ...
        if (this.batchedInstances.size() > this.currentBatchedInstance) {
            this.batchedInstances.subList(this.currentBatchedInstance, this.batchedInstances.size()).clear();
        }

        if (this.instances.size() > this.currentInstance) {
            this.instances.subList(this.currentInstance, this.instances.size()).clear();
        }
        this.instances.sort(this.instanceDepthComparator);
