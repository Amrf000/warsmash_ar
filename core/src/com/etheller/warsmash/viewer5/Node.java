...
public abstract class Node extends GenericNode {
    ...
    public static <NODE extends SkeletalNode> Object[] createSkeletalNodes(final int count,
        ...
        return new Object[]{nodes, worldMatrices};
    }
    ...
    public void setTransformation(final Vector3 location, final Quaternion rotation, final Vector3 scale) {
    ...
    public void setLocalRotation(final Quaternion rotation) {
        this.localRotation.set(rotation);
    ...
    public void uniformScale(final float scale) {
    ...
    public void setParent(final GenericNode parent) {
        if (this.parent != null) {
