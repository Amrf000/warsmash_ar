...
public interface GamingNetworkServerToClientListener extends DisconnectListener {
    ...
    final class GamingNetworkServerToClientNotifier implements GamingNetworkServerToClientListener {
    ...
    abstract class GamingNetworkServerToClientListenerAdapter
