...
public class SelectableChannelOpener implements ChannelOpener {
    ...
    @Override
    public void openUDPServerChannel(final int port, final UdpServerListener listener,
    ...
    @Override
    public void openTCPServerChannel(final int port, final SocketChannelCallback callback,
                                     final ExceptionListener exceptionListener, final int bufferSize, final ByteOrder byteOrder) {
        try {
            ensureSelectorOpen();
