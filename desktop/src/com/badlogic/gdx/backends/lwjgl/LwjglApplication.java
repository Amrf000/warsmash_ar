...
public class LwjglApplication implements Application {
    ...
    protected final String preferencesdir;
    protected final Files.FileType preferencesFileType;
    final ObjectMap<String, Preferences> preferences = new ObjectMap<>();
    ...
    @Override
    public void exit() {
        postRunnable(() -> LwjglApplication.this.running = false);
    }
